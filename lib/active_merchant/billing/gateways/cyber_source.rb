  ...
  module Billing #:nodoc:
    ...
    class CyberSourceGateway < Gateway
      ...
      def add_stored_credential_options(xml, options={})
        ...
        xml.subsequentAuthTransactionID options.dig(:stored_credential_overrides, :transaction_id) || stored_credential_transaction_id
        xml.subsequentAuthStoredCredential options.dig(:stored_credential_overrides, :stored_credential) || stored_credential_subsequent_auth_stored_cred
      end
